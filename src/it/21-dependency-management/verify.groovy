...
assert prjText.contains("""!classpathentry lib/junit-4.8.2.jar
  -optimize=all
  -protect=all
  -pack=all
!end""")
...
assert prjText.contains("""!classpathentry lib/jackson-databind-2.8.0.jar
  -optimize=autodetect
  -protect=all
  -pack=none
!end""")
assert prjText.contains("""!classpathentry lib/jackson-annotations-2.8.0.jar
  -optimize=autodetect
  -protect=all
!end""")
assert prjText.contains("""!classpathentry lib/jackson-core-2.8.0.jar
  -optimize=all
  -protect=all
!end""")

assert log4jDep.exists()
assert prjText.contains("""!classpathentry libs/log4j-1.2.17.jar
  -optimize=autodetect
  -protect=nomatter
  -pack=none
!end""")
