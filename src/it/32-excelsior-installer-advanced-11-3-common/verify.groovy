...
assert xpackArgs.contains("-installation-directory /mavenPluginTestEI")
assert xpackArgs.contains("-installation-directory-type current-directory")
assert xpackArgs.contains("-installation-directory-fixed")
assert xpackArgs.contains("-install-callback")
assert xpackArgs.contains("-uninstall-callback")
